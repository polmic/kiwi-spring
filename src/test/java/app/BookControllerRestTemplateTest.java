...
public class BookControllerRestTemplateTest {
    ...
    @Before
    public void init() {
        Book book = new Book(1L, "app.models.Book Name", "Mkyong", new BigDecimal("9.99"));
    ...
    public void find_bookId_OK() throws JSONException {
        ...
        String expected = "{id:1,name:\"app.models.Book Name\",author:\"Mkyong\",price:9.99}";
    ...
    public void find_allBook_OK() throws Exception {
        ...
        List<Book> books = Arrays.asList(
                new Book(1L, "app.models.Book A", "Ah Pig", new BigDecimal("1.99")),
                new Book(2L, "app.models.Book B", "Ah Dog", new BigDecimal("2.99")));
    ...
    public void find_bookIdNotFound_404() throws Exception {
        ...
        String expected = "{status:404,app.error:\"Not Found\",message:\"app.models.Book id not found : 5\",path:\"/books/5\"}";
    ...
    public void patch_bookPrice_405() throws JSONException {
        ...
        String expected = "{status:405,app.error:\"Method Not Allowed\",message:\"Field [price] update is not allow.\"}";
